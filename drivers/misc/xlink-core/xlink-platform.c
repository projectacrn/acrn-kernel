...
int (*write_fcts[NMB_OF_INTERFACES])(uint32_t, void *, size_t * const,
		uint32_t) = {NULL, xlink_pcie_write, NULL, NULL};

int (*read_fcts[NMB_OF_INTERFACES])(uint32_t, void *, size_t * const,
		uint32_t) = {NULL, xlink_pcie_read, NULL, NULL};
