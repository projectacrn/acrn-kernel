					...
					const struct pci_device_id *id)
{
	...
	ret = mfd_add_devices(&pci->dev, PLATFORM_DEVID_AUTO, intel_ehl_pse_gpio_mfd_devs, 
			ARRAY_SIZE(intel_ehl_pse_gpio_mfd_devs), pdata->mem, pdata->irq, NULL);
...
static const struct dev_pm_ops intel_ehl_pse_gpio_mfd_pm_ops = {
	SET_RUNTIME_PM_OPS(intel_ehl_pse_gpio_mfd_runtime_suspend, intel_ehl_pse_gpio_mfd_runtime_resume, NULL)
	SET_SYSTEM_SLEEP_PM_OPS(intel_ehl_pse_gpio_mfd_suspend, intel_ehl_pse_gpio_mfd_resume)
};
