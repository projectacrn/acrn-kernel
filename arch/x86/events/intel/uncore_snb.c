...
/* CNL Cbo register */
#define CNL_UNC_CBO_CONFIG			0x396
#define CNL_UNC_NUM_CBO_MASK			0xf
#define CNL_UNC_CBO_0_PER_CTR0			0x702
#define CNL_UNC_CBO_MSR_OFFSET			0x8
...
static struct intel_uncore_type cnl_uncore_cbox = {
	.name		= "cbox",
	.num_counters   = 4,
	.perf_ctr_bits	= 44,
	.perf_ctr	= CNL_UNC_CBO_0_PER_CTR0,
	.event_ctl	= SNB_UNC_CBO_0_PERFEVTSEL0,
	.event_mask	= SNB_UNC_RAW_EVENT_MASK,
	.msr_offset	= CNL_UNC_CBO_MSR_OFFSET,
	.ops		= &skl_uncore_msr_ops,
	.format_group	= &snb_uncore_format_group,
};

static struct uncore_event_desc cnl_uncore_events[] = {
	INTEL_UNCORE_EVENT_DESC(clockticks, "event=0xff"),
	{ /* end: all zeroes */ },
};

static struct attribute *cnl_uncore_clock_formats_attr[] = {
	&format_attr_event.attr,
	NULL,
};

static struct attribute_group cnl_uncore_clock_format_group = {
	.name = "format",
	.attrs = cnl_uncore_clock_formats_attr,
};

static struct intel_uncore_type cnl_uncore_clockbox = {
	.name		= "clock",
	.num_counters	= 1,
	.num_boxes	= 1,
	.fixed_ctr_bits	= 48,
	...
	.format_group	= &cnl_uncore_clock_format_group,
	.ops		= &skl_uncore_msr_ops,
	.event_descs	= cnl_uncore_events,
};

static struct intel_uncore_type *cnl_msr_uncores[] = {
	&cnl_uncore_cbox,
	&snb_uncore_arb,
	&cnl_uncore_clockbox,
	NULL,
...
static int cnl_get_cbox_num(void)
{
	u64 num_boxes;

	rdmsrl(CNL_UNC_CBO_CONFIG, num_boxes);

	return num_boxes & CNL_UNC_NUM_CBO_MASK;
}

void cnl_uncore_cpu_init(void)
{
	uncore_msr_uncores = cnl_msr_uncores;
	cnl_uncore_cbox.num_boxes = cnl_get_cbox_num();
	snb_uncore_arb.ops = &skl_uncore_msr_ops;
}
